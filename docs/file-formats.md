...
**Generated by:** `salt-bundle install`
...
**Generated by:** `salt-bundle index`
...
```bash
salt-bundle index --base-url https://cdn.example.com/packages/
```
...
**Created by:** `salt-bundle add-repo`
